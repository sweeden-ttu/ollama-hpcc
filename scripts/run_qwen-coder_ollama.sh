...
# SLURM batch script: launch an OLLAMA server running Qwen2.5-Coder on RedRaider
# Partition: matador (GPU)
#
# Submit with:  sbatch run_qwen-coder_ollama.sh
# Or via MPI:   bash mpi_run.sh run_qwen-coder_ollama.sh
# =============================================================================

#SBATCH --job-name=ollama-qwen-coder
...
MODEL_VERSION="${QWENCODER_VERSION}"
